...
if [[ -f "${REPO_ROOT}/infra/local-stack.env" ]]; then
  ...
  OBJECT_STORAGE_ENDPOINT="${S3_ENDPOINT:-${OBJECT_STORAGE_ENDPOINT:-}}"
  OBJECT_STORAGE_ACCESS_KEY="${S3_ACCESS_KEY:-${OBJECT_STORAGE_ACCESS_KEY:-}}"
  OBJECT_STORAGE_SECRET_KEY="${S3_SECRET_KEY:-${OBJECT_STORAGE_SECRET_KEY:-}}"
  OBJECT_STORAGE_BUCKET="${MINIO_BUCKET:-${OBJECT_STORAGE_BUCKET:-}}"
  export OBJECT_STORAGE_ENDPOINT OBJECT_STORAGE_ACCESS_KEY
  export OBJECT_STORAGE_SECRET_KEY OBJECT_STORAGE_BUCKET
fi
